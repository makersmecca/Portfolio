      ...
      <div className="mt-10 md:mt-24 pt-5 grid grid-cols-2 md:grid-cols-6 xl:px-80 lg:px-52 md:px-36 px-8 mb-10">
        ...
        <div className="col-start-1 col-span-4 flex flex-row md:justify-start justify-around">
          ...
          >
            ...
            <span className="md:block hidden group-hover:scale-105 transition-transform duration-200 ease-in-out">
              Github
            </span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          <a
            href="https://www.linkedin.com/in/ayudh-nandi"
            target="_blank"
            rel="noopener noreferrer"
          ...
          <a
            href="mailto:ayudhnandi@gmail.com"
            target="_blank"
            rel="noopener noreferrer"
            className="flex justify-center items-end mt-3 md:mt-0 md:me-14 group"
          >
